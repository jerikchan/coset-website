...
const partnersData: {
  ...
  {
    icon: "/images/logo/movefuns.png",
    title: "Movefuns",
    link: "https://movefuns.org/",
  ...
  {
    icon: "/images/logo/movebit.png",
    title: "Movebit",
    link: "https://movebit.xyz/",
    tag: "Partner",
  },
  {
    icon: "/images/logo/bucketprotocol.png",
  ...
  // https://www.smartdeer.work/
  {
    icon: "/images/logo/smartdeer.png",
    title: "SmartDeer",
    link: "https://www.smartdeer.work/",
    tag: "Community Support",
  },
  // keymap
  {
    icon: "/images/logo/keymap.png",
    title: "KeyMap",
    tag: "Community Support",
  },
  // talentex
  {
    icon: "/images/logo/talentex.png",
    title: "TalentEx",
    link: "http://www.talentex.xyz/",
    tag: "Community Support",
  },
];
            ...
            <div key={x.title ?? x.link} className="flex flex-col h-full">
              {x.link ? (
                <a
                  ...
                  className="max-w-xs p-12 py-12 bg-white border border-web-gray/30 hover:opacity-75 transition flex justify-center items-center flex-1 hover:underline"
                >
                  {imageNode}
                </a>
              ) : (
                <div className="max-w-xs p-12 py-12 bg-white border border-web-gray/30 hover:opacity-75 transition flex justify-center items-center flex-1">
                  {imageNode}
                </div>
              )}
