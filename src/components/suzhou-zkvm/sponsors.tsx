        ...
        {sponsorsData.map((x) => (
          <div key={x.title ?? x.link} className="flex flex-col h-full bg-white rounded-2xl overflow-hidden">
            <a
              ...
              className="max-w-xs px-12 py-12 hover:opacity-75 transition flex justify-center items-center flex-1 hover:underline"
            >
            ...
            <div className="bg-white border-t border-web-gray/30 -mt-[1px] flex justify-center items-center py-3 text-web-black">
              {x.tag}
            </div>
          </div>
        ))}
