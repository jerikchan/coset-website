...
const supportersData = [
  ...
  {
    icon: "/images/logo/naviprotocol.png",
    title: "Navi Protocol",
  ...
  {
    icon: "/images/logo/scallop.png",
    title: "Scallop",
    link: "https://scallop.io/",
    tag: "Community Support",
    containerClassName: "p-4"
  },
  {
...
export const CommunitySupports = (props: React.ComponentProps<"div">) => {
  return (
    <div
      className="py-16 md:py-48 flex flex-col space-y-12 justify-center items-center bg-white"
      {...props}
    >
      ...
      <div className="py-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {supportersData.map((x) => (
          <div
            key={x.title ?? x.link}
            className={clsx("flex flex-col w-72",)}
          >
            <a
              href={x.link}
              target="_blank"
